...
export class AppComponent {
  ...
  async submit(inputCont : HTMLInputElement) {
    ...
    const repos = await this.repoListingService.getReposforUserName(userName, this.currentPage)
  ...
  async onPageNumberChange(pageNumber : number, direction : string  = this.direction) {
